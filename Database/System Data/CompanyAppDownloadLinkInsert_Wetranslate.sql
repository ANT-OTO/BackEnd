...
-- Company iPhone Client App Block
...
declare @pCompanyCode nvarchar(64) = '',
		...
		@pCompanyId int = 0
select @pCompanyCode = 'Wetranslate',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/wetranslate/id1207977608?l=zh&ls=1&mt=8',
		@pLastestVersion = '3.0'
...
-- Company iPhone Provider App Block
declare @pTime datetime = getutcdate()
declare @pCompanyCode nvarchar(64) = '',
		@pApplicationTypeCodeId int = 0,
		@pDeviceTypeCodeId int = 0,
...
select @pCompanyCode = 'Wetranslate',
		...
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/app/weyivideo-provider/id1119283449?mt=8',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
-- Company Android Client App Block
declare @pTime datetime = getutcdate()
declare @pCompanyCode nvarchar(64) = '',
		@pApplicationTypeCodeId int = 0,
		@pDeviceTypeCodeId int = 0,
...
select @pCompanyCode = 'Wetranslate',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=io.wetranslate.client',
		@pLastestVersion = '3.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
-- Company Android Provider App Block
declare @pTime datetime = getutcdate()
declare @pCompanyCode nvarchar(64) = '',
		@pApplicationTypeCodeId int = 0,
		@pDeviceTypeCodeId int = 0,
...
select @pCompanyCode = 'Wetranslate',
		@pApplicationTypeCodeId = 2, --select * from CodeList where Category = 'ApplicationType' 
		@pDeviceTypeCodeId = 2, --select * from CodeList where Category = 'DeviceType'
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.weyivideoprovider',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select * from WEYI.dbo.CompanyAppDownLoadLink a (nolock)
	...
	where b.CompanyCode = 'Wetranslate'