...
declare @pCompanyCode nvarchar(64) = '',
		...
		@pCompanyId int = 0
select @pCompanyCode = 'Dragoman',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/simultele-client/id1231785005?ls=1&mt=8',
		@pLastestVersion = '3.0'
...
select @pCompanyCode = 'Dragoman',
		...
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/simultele-provider/id1231786011?ls=1&mt=8',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'Dragoman',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.dragomancustomer',
		@pLastestVersion = '3.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'Dragoman',
		@pApplicationTypeCodeId = 2, --select * from CodeList where Category = 'ApplicationType' 
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.dragomanappprovider',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
