...
declare @pCompanyCode nvarchar(64) = '',
		...
		@pCompanyId int = 0
select @pCompanyCode = 'ECDC',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/ecdc-client/id1235885372?ls=1&mt=8',
		@pLastestVersion = '3.0'
...
select @pCompanyCode = 'ECDC',
		...
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/ECDC-provider/id1227546976?mt=8',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'ECDC',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.ecdccustomer',
		@pLastestVersion = '3.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'ECDC',
		@pApplicationTypeCodeId = 2, --select * from CodeList where Category = 'ApplicationType' 
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.ecdcappprovider',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
