...
declare @pCompanyCode nvarchar(64) = '',
		...
		@pCompanyId int = 0
select @pCompanyCode = 'ServiceHub',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/app/servicehub-client/id1313075776?mt=8',
		@pLastestVersion = '3.0'
...
select @pCompanyCode = 'ServiceHub',
		...
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/app/servicehub-provider/id1313086913?mt=8',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'ServiceHub',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.ServiceHubcustomer',
		@pLastestVersion = '3.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'ServiceHub',
		@pApplicationTypeCodeId = 2, --select * from CodeList where Category = 'ApplicationType' 
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.ServiceHubappprovider',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select * from WEYI.dbo.CompanyAppDownLoadLink a (nolock)
	...
	where b.CompanyCode = 'ServiceHub'
