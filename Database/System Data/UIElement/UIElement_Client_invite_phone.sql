EXECUTE [dbo].[sp_UIElementSave] @pAppName = 'Client', 	@pElementKey = 'invite_phone',	@pSystemLanguageId = 2,		-- 简体中文	zh-CN
	@pContentInSystemLanguage = N'输入电话号码以邀请', @pContentEnglish = N'Type in phone number to invite'

EXECUTE [dbo].[sp_UIElementSave] @pAppName = 'Client', 	@pElementKey = 'invite_phone',	@pSystemLanguageId = 14,		-- de
