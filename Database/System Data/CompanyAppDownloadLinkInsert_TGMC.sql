...
declare @pCompanyCode nvarchar(64) = '',
		...
		@pCompanyId int = 0
select @pCompanyCode = 'TGMC',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/tgmc-client/id1227256599?mt=8',
		@pLastestVersion = '3.0'
...
select @pCompanyCode = 'TGMC',
		...
		@pDeviceTypeCodeId = 1,
		@pDownLoadLink = 'https://itunes.apple.com/us/app/tgmc-provider/id1227546976?mt=8',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'TGMC',
		@pApplicationTypeCodeId = 1,
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.tgmccustomer',
		@pLastestVersion = '3.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
...
select @pCompanyCode = 'TGMC',
		@pApplicationTypeCodeId = 2, --select * from CodeList where Category = 'ApplicationType' 
		@pDeviceTypeCodeId = 2,
		@pDownLoadLink = 'https://play.google.com/store/apps/details?id=com.weyimobile.weyiandroid.tgmcappprovider',
		@pLastestVersion = '2.0'
select @pCompanyId = Id
from WEYIMgr.dbo.Company (nolock)
where CompanyCode = @pCompanyCode
