...
ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_CreateDate]  DEFAULT (getutcdate()) FOR [CreateDate]
ALTER TABLE [dbo].[Country] ADD  CONSTRAINT [DF_Country_LastUpdate]  DEFAULT (getutcdate()) FOR [LastUpdate]
