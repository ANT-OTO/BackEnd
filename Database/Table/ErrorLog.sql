...
Begin
	...
	(   select fk.constraint_object_id from sys.foreign_key_columns as fk
		where fk.referenced_object_id = 
    		(select object_id from sys.tables where name = 'ErrorLog')
	)	
	
	
	declare @TblName as nvarchar(64) = 'ErrorLog'
	select distinct '
...
CREATE TABLE [dbo].[ErrorLog](
	...
	[LastUpdateByType] [int] NOT NULL,		-- 1: Agent, 
											-- select * from dbo.CodeList where Category like 'AppErrorLogType'
...
ALTER TABLE [dbo].[ErrorLog] ADD  CONSTRAINT [DF_ErrorLog_LastUpdate]  DEFAULT (getutcdate()) FOR [LastUpdate]
...
DROP INDEX [IX_ErrorLog_1] ON [dbo].[ErrorLog]
GO




/****** Object:  Index [IX_ErrorLog_1]    Script Date: 2/2/2015 9:14:23 AM ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_ErrorLog_1] ON [dbo].[ErrorLog]
(
	[Type] ASC
