...
/****** Object:  Table [dbo].[RequestCall]    Script Date: 01/15/2015 21:55:07 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RequestCall]') AND type in (N'U'))
Begin
	/*
	
	DROP TABLE [dbo].[RequestCall]
	...
	(   select fk.constraint_object_id from sys.foreign_key_columns as fk
		where fk.referenced_object_id = 
    		(select object_id from sys.tables where name = 'RequestCall')
	)	
	

	
	declare @TblName as nvarchar(64) = 'RequestCall'
	select distinct '
...
'
	...
	*/
	...
	print 'you need to manually exec DROP TABLE [dbo].[RequestCall] ' + convert(varchar, getdate())
	
End
else
begin

CREATE TABLE [dbo].[RequestCall](
 ...
 CONSTRAINT [PK_RequestCall] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[RequestCall] ADD  CONSTRAINT [DF_RequestCall_CreateDate]  DEFAULT (getdate()) FOR [CreateDate]
ALTER TABLE [dbo].[RequestCall] ADD  CONSTRAINT [DF_RequestCall_LastUpdate]  DEFAULT (getdate()) FOR [LastUpdate]
...
/****** Object:  Index [IX_RequestCall_1]    Script Date: 01/16/2015 11:50:36 ******/
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[RequestCall]') AND name = N'IX_RequestCall_1')
DROP INDEX [IX_RequestCall_1] ON [dbo].[RequestCall]
GO




/****** Object:  Index [IX_RequestCall_1]    Script Date: 2/2/2015 9:14:23 AM ******/
CREATE NONCLUSTERED INDEX [IX_RequestCall_1] ON [dbo].[RequestCall]
(
	[RequestId] ASC
