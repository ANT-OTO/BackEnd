...
/****** Object:  Table [dbo].[RequestEvalByProvider]    Script Date: 01/15/2015 21:55:07 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RequestEvalByProvider]') AND type in (N'U'))
Begin
	/*
	
	DROP TABLE [dbo].[RequestEvalByProvider]
	...
	(   select fk.constraint_object_id from sys.foreign_key_columns as fk
		where fk.referenced_object_id = 
    		(select object_id from sys.tables where name = 'RequestEvalByProvider')
	)	
	
	declare @TblName as nvarchar(64) = 'RequestEvalByProvider'
	select distinct '
...
'
	...
	*/
	...
	print 'you need to manually exec DROP TABLE [dbo].[RequestEvalByProvider] ' + convert(varchar, getdate())
	
End
else
begin

CREATE TABLE [dbo].[RequestEvalByProvider](
 ...
 CONSTRAINT [PK_RequestEvalByProvider] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
select * from [RequestEvalByProvider]
end
...
/****** Object:  Index [IX_RequestEvalByProvider_1]    Script Date: 01/16/2015 11:50:36 ******/
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[RequestEvalByProvider]') AND name = N'IX_RequestEvalByProvider_1')
DROP INDEX [IX_RequestEvalByProvider_1] ON [dbo].[RequestEvalByProvider]
GO




/****** Object:  Index [IX_RequestEvalByProvider_1]    Script Date: 2/2/2015 9:14:23 AM ******/
CREATE NONCLUSTERED INDEX [IX_RequestEvalByProvider_1] ON [dbo].[RequestEvalByProvider]
(
	[RequestId] ASC,
	[ProviderId] ASC,
	[EvalQuestionId] ASC
