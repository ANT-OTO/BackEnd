...
/****** Object:  Table [dbo].[UIElementY]    Script Date: 01/15/2015 21:55:07 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UIElementY]') AND type in (N'U'))
Begin
	/*
	
	DROP TABLE [dbo].[UIElementY]
	...
	(   select fk.constraint_object_id from sys.foreign_key_columns as fk
		where fk.referenced_object_id = 
    		(select object_id from sys.tables where name = 'UIElementY')
	)	
	

	declare @TblName as nvarchar(64) = 'UIElementY'
	select distinct '
...
'
	...
	*/
	...
	print 'you need to manually exec DROP TABLE [dbo].[UIElementY] ' + convert(varchar, getdate())
	
End
else
begin

CREATE TABLE [dbo].[UIElementY](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[UIElementId] [int] NOT NULL,
	[SystemLanguageId] [int] NOT NULL,
	[Content] [nvarchar](max) NOT NULL,			
	[CreateDate] [datetime] NOT NULL,
 CONSTRAINT [PK_UIElementY] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[UIElementY] ADD  CONSTRAINT [DF_UIElementY_CreateDate]  DEFAULT (getdate()) FOR [CreateDate]
...
/****** Object:  Index [IX_UIElementY_1]    Script Date: 01/16/2015 11:50:36 ******/
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[UIElementY]') AND name = N'IX_UIElementY_1')
DROP INDEX [IX_UIElementY_1] ON [dbo].[UIElementY]
GO




/****** Object:  Index [IX_UIElementY_1]    Script Date: 2/2/2015 9:14:23 AM ******/
CREATE NONCLUSTERED INDEX [IX_UIElementY_1] ON [dbo].[UIElementY]
(
	[UIElementId] ASC,
