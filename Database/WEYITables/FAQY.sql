...
/****** Object:  Table [dbo].[FAQY]    Script Date: 01/15/2015 21:55:07 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FAQY]') AND type in (N'U'))
Begin
	/*
	...
	(   select fk.constraint_object_id from sys.foreign_key_columns as fk
		where fk.referenced_object_id = 
    		(select object_id from sys.tables where name = 'FAQY')
	)	
	
	
	declare @TblName as nvarchar(64) = 'FAQY'
	select distinct '
...
'
	...
	*/
	...
	print 'you need to manually exec DROP TABLE [dbo].[FAQY] ' + convert(varchar, getdate())
	
End
else
begin

CREATE TABLE [dbo].[FAQY](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[FAQId] [int] NOT NULL,
	[SystemLanguageId] [int] NOT NULL,
	[Content] [nvarchar](max) NOT NULL,
	[CreateDate] [datetime] NOT NULL,
 CONSTRAINT [PK_FAQY] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [dbo].[FAQY] ADD  CONSTRAINT [DF_FAQY_CreateDate]  DEFAULT (getdate()) FOR [CreateDate]
...
/****** Object:  Index [IX_FAQY_1]    Script Date: 01/16/2015 11:50:36 ******/
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[FAQY]') AND name = N'IX_FAQY_1')
DROP INDEX [IX_FAQY_1] ON [dbo].[FAQY]
GO




/****** Object:  Index [IX_FAQY_1]    Script Date: 2/2/2015 9:14:23 AM ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_FAQY_1] ON [dbo].[FAQY]
(
	[FAQId] ASC,
